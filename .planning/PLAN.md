...
2. Frontend
   - index.html with title and buttons
   - style.css for basic layout and tables
   - script.js for fetch calls and rendering lists/stats

3. Docs
   - Add README setup steps, run instructions, and seed info
